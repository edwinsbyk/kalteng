...
class userdata_model extends CI_Model
{
    ...
    public function tambahdataUser($email ,$name ,$password, $image , $role_id , $is_active)
    {

        $hasil = $this->db->query("INSERT INTO `user`(`id`, `name`, `email`, `image`, `password`, `role_id`, `is_active`, `date_created`) VALUES (NULL,'$name','$email','$image','$password','$role_id','$is_active','');");
        return $hasil;
    }
