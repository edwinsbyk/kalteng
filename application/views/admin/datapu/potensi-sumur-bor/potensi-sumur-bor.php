                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="table" role="tabpanel" aria-labelledby="home-tab">
                            <?php $this->load->view('admin/datapu/potensi-sumur-bor/tabeldata_potensi_sumur_bor') ?>
                        </div>
                        <div class="tab-pane fade" id="tambah" role="tabpanel" aria-labelledby="home-tab">
                            <?php $this->load->view('admin/datapu/potensi-sumur-bor/tambahdata_potensi_sumur_bor') ?>
                        </div>
                    </div>
