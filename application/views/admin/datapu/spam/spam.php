            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#table" role="tab" aria-controls="home" aria-selected="true">Data PU SPAM</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="table" role="tabpanel" aria-labelledby="home-tab">
                            <?php $this->load->view('admin/datapu/spam/tabeldata_spam') ?>
                        </div>
                        <div class="tab-pane fade" id="tambah" role="tabpanel" aria-labelledby="home-tab">
                            <?php $this->load->view('admin/datapu/spam/tambahdata_spam') ?>
                        </div>
                    </div>
