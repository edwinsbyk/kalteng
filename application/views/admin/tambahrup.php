                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-text" class=" form-control-label">Kegiatan atau Paket</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hf-text" name="kegiatan" placeholder="Masukkan Kegiatan" class="form-control">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hf-text" name="hf-text" placeholder="Masukkan Kegiatan" class="form-control">
