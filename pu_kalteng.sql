...
INSERT INTO `tbl_danau` (`id_danau`, `nama`, `kota`, `luas`, `kedalaman`, `kapasitas`, `penduduk`, `ternak`, `irigasi`) VALUES
...
CREATE TABLE `tbl_jalan` (
  ...
  `aspal` varchar(128) NOT NULL,
  `japat` varchar(128) NOT NULL,
  `tanah` varchar(128) NOT NULL,
  `beton` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_jembatan` (`id_jembatan`, `nama`, `kota`, `panjang`, `lebar`, `atas`, `bawah`, `sungai`) VALUES
...
CREATE TABLE `tbl_rawa` (
  ...
  `sudah_manfaat` varchar(255) NOT NULL,
  `belum_manfaat` varchar(255) NOT NULL,
...
INSERT INTO `tbl_rawa` (`id_rawa`, `nama`, `jenis`, `kota`, `sudah_kembang`, `belum_kembang`, `sudah_manfaat`, `belum_manfaat`, `total`, `tahun`) VALUES
...
INSERT INTO `tbl_sumurbor` (`tbl_sumurbor`, `nama`, `kota`, `debit`, `air_baku`, `irigasi`) VALUES
...
--
ALTER TABLE `tbl_black_spot`
  MODIFY `id_black_spot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_danau`
--
ALTER TABLE `tbl_danau`
  MODIFY `id_danau` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_embung`
--
ALTER TABLE `tbl_embung`
  MODIFY `id_embung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_jalan`
--
ALTER TABLE `tbl_jalan`
  MODIFY `id_jalan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_jembatan`
--
ALTER TABLE `tbl_jembatan`
  MODIFY `id_jembatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_pemenang_lelang`
--
ALTER TABLE `tbl_pemenang_lelang`
  MODIFY `id_pemenang_lelang` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_potensi_sumur_bor`
--
ALTER TABLE `tbl_potensi_sumur_bor`
  MODIFY `id_sumur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_rawa`
--
ALTER TABLE `tbl_rawa`
  MODIFY `id_rawa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_spam`
--
ALTER TABLE `tbl_spam`
  MODIFY `id_spam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_sumurbor`
--
ALTER TABLE `tbl_sumurbor`
  MODIFY `tbl_sumurbor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
